...
motor_stanga_fwd = GPIO.PWM(motor_stanga_fata, 20)
motor_stanga_bwd = GPIO.PWM(motor_stanga_spate, 20)
motor_dreapta_fwd = GPIO.PWM(motor_dreapta_fata, 20)
motor_dreapta_bwd = GPIO.PWM(motor_dreapta_spate, 20)
