...
motor_stanga_fwd = GPIO.PWM(motor_stanga_fata, 40)
motor_stanga_bwd = GPIO.PWM(motor_stanga_spate, 40)
motor_dreapta_fwd = GPIO.PWM(motor_dreapta_fata, 40)
motor_dreapta_bwd = GPIO.PWM(motor_dreapta_spate, 40)
